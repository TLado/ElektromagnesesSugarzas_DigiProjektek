...
Ez a fejezet a C# alapú Windows Forms alkalmazás működésére és felépítésére fókuszál. A Python komponens leírása a 2. fejezetben található.

  

Az alkalmazás célja egy irodai környezet vizuális modellezése rácsalapú megközelítéssel. A felhasználó egy grafikus felületen helyezheti el az elektromágneses sugárzást kibocsátó eszközöket, majd az így létrehozott elrendezést egy strukturált CSV fájlba mentheti.
...
>  **Megjegyzés:** ez egy rövid összefoglaló, a használathoz olvassa el a **[felhasználói dokumentációt](https://github.com/TLado/ElektromagnesesSugarzas_DigiProjektek/blob/main/Felhaszn%C3%A1l%C3%B3i%20dokument%C3%A1ci%C3%B3.md)**.
...
A grid létrehozásakor a rendszer automatikusan falakat helyez el a szoba határain.
...
A mentés során az aktuális állapot CSV formátumba kerül mentésre. A mentési folyamat után az alkalmazás elindít a Python scriptből képzett futtatható .EXE állományt, megjelenítve a csv fájl által tartalmazott adatokat.
